...
export default function Notfound() {
  return (
    <>
      <Header />
      <Container>
        <div className="bg-404 bg-cover bg-center flex flex-col items-center justify-center gap-6 sm:gap-16 md:gap-14 px-12 sm:px-20 md:px-56 xl:px-[432px] py-52 sm:py-56 md:py-44">
          <div className="flex flex-col items-center justify-center gap-[14px] sm:gap-5">
            ...
            <span className="font-lora font-semibold text-xl sm:text-5xl text-[#272940] md:py-5 text-center">
              We’re sorry, this page is not active.
            </span>
          </div>
          <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8">
            <div
              ...
              />
              <span className="font-manrope font-semibold text-xs sm:text-xl text-[#272940]">
                Go back
              </span>
            </div>
            <div
              className="w-32 h-11 sm:w-[250px] sm:h-24 md:w-[230px] md:h-[75px] flex flex-row justify-center items-center px-6 py-[10px] sm:px-12 sm:py-6 gap-6 bg-[#816BD9] rounded cursor-pointer hover:opacity-80 order-first md:order-last"
              style={{
                boxShadow:
        ...
        <div className="flex flex-col items-start gap-12 md:gap-[80px]">
