    ...
    <Layout navData={data} active={"Services"}>
      ...
      <div className="mt-10">
        ...
        <p>
          ...
          date. The grounds for opposing a trade mark application that an
          opponent can rely on are explained below.
        </p>
        <figure>
          <table>
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <p>
                    &ldquo;Use contrary to law refers&rdquo; to the
                    contravention of a specific legislative body, for example
                    that the mark uses a geographical indication in relation to
                    the provision of wine, meaning it could potentially
                    contravene the{' '}
              ...
              <tr>
                ...
                <td>
                  ...
                  is likely to cause confusion. The confusion may be with
                  regards to:
                  <ul>
                    <li>
              ...
              <tr>
                ...
                <td>
                  Ownership of a mark in Australia will be established through
                  the use of the mark. Under this ground, an opponent may show
                  that it used the mark before the date of Application of the
                  Opposed mark and is therefore the owner of that mark.{' '}
                  <strong>Section 58A:</strong> In cases where the application
                  was accepted under prior use, the Opponent may rely on this
                  ground to show earlier use of the mark.
                </td>
              </tr>
              <tr>
                <th scope="row">
                ...
                <td>
                  ...
                  />
                  <p>
                    This ground may be raised on the basis that the applicant
                    did not at the filing date intend to use the mark as a badge
                    of origin. For example, in{' '}
                    ...
                    indicate that a product could be recycled and this was not
                    use as a <em>badge of origin</em>.
                  </p>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  opposed based on Ebay Incorporated&apos;s reputation in its
                  EBAY trade mark.
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  Under this ground, an opposition may be based on the mark
                  being amended contrary to the <em>Trade Marks Act</em> or
                  being accepted on the basis of a false representation of
                  Evidence.
                </td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  knowledge that another party was already using that mark.
                  Since this ground often deals with the consideration of the
                  intention of the applicant at the time of filing, it can be
