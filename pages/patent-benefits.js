  ...
  return (
    <Layout>
      ...
      <nav className="flex overflow-x-auto not-format" aria-label="Breadcrumb">
        <ol className="inline-flex items-center md:pt-5 pt-0 pb-6 space-x-1 md:space-x-3 list-none pm-25 whitespace-nowrap">
      ...
      <p>
        ...
        inventors with a monopoly to develop and commercialise their invention.
        Applying for a patent can be a fairly lengthy process but there are many
      ...
      <p>
        ...
        introduced to the market and becomes highly commercialised, it is often
        reverse engineered or copied by competitors. This often allows the
        competitors to sell the same or similar product at a lower price as they
        did not have to bear the original costs associated with research and
        development. If the invention is not protected, the originator will have
        to rely on its brand name or reduce its prices to remain competitive. If
        patent protection has been obtained, the originator will be able to
        issue a cease and desist letter to the competitors. Legal proceedings
        can also be commenced, if necessary, to enforce the patent, restrict
      ...
      <p>
        ...
        benefits. The Australian Government is introducing a “patent box” system
      ...
      <p>
        ...
        to rely on the use of confidentiality agreements. There are many
        pitfalls in relying on confidentiality agreements to protect an
        invention, these include difficulties in enforcing the agreement,
        difficulties in quantifying and calculating remedies for breach and the
      ...
      <p>
        ...
        applications and the like) and were therefore not able to apply for a
        patent. It is important to note that Australia (like most jurisdictions)
        is a “first to file”, and not a “first to invent” jurisdiction. If two
        inventors are working on a similar invention in parallel, the first to
        file will be granted the patent (assuming all other requirements are
        met) and the other inventor will then have no rights to commercialise
      ...
      <p>
        ...
        application. The filing of a provisional patent establishes an
      ...
      <p>
        ...
        successful patenting strategy involves deciding in which jurisdiction to
        file, drafting the claims in the patent appropriately so it has less
        chance of being contested and managing any identified competitor
        infringements. The ability to enforce a patent and restrict competition
        depends on the drafting of the claims in the patent application and the
        scope of the invention. It is, thus, vitally important to consult a
        professional patent attorney who can ensure that the claims are drafted
        to provide maximum protection and are yet not so broad that the
        requirements of examination cannot be met. Baxter IP has the skill and
        expertise required to advise you on every step of your patenting
        journey.
      </p>
    </Layout>
  )
