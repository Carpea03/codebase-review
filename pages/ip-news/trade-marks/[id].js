...
import { tradeMarks } from '../../../utils/const/ids'
...
export const getStaticPaths = async () => {
  ...
  const data = filterHelper(morePosts, false, tradeMarks)
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="IP Front™ - The latest trade mark news across by Baxter IP."
        />
        <link
          rel="canonical"
      ...
      >
        <div className="mt-10">
          {morePosts.length > 0 && (
            <Content posts={morePosts} title={'Trade Mark Articles'} />
          )}
        </div>
      </Layout>
    </>
