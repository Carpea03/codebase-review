  ...
  return (
    <Layout>
      ...
      <div className="text-sm">
        <Link
          href="mailto:warren.chandler@baxterip.com.au"
          className="text-xs">
      ...
      <p>
        ...
        <Link href="https://www.baxterip.com.au/ip-strategy">IP strategy</Link>,
        you also earn the admiration of both colleagues and clients. But for
        Warren Chandler, it&rsquo;s only ever been about creating strong
        intellectual property assets for his clients.
      </p>
      ...
      <p>
        ...
        &nbsp;(at the division of Animal Production) were traversed during this
        time. With the dawn of the 90s, Warren registered as a patent attorney,
        commencing in his area of speciality, applied chemistry and methods of
        treatment of diseased states in animals and humans.
      </p>
      ...
      <ul class="text-left">
        ...
        <li>
          Extensive{' '}
          <Link href="https://www.baxterip.com.au/patent-opposition">
            patent oppositions
          </Link>{' '}
          and{' '}
