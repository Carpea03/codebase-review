    ...
    <Layout navData={data} active={"Articles"}>
      ...
      <div className="mt-10">
        ...
        <section>
          ...
          <p>
            Your patent or trade mark attorney has obligations of
            confidentiality under Federal Law that are very similar to those of
            a lawyer. You can talk with confidence about your idea with your
            attorney as this will enable them to give you the best possible
            advice.
          </p>
          <h3>Do you offer IP litigation services?</h3>
          <p>
            IP specialist lawyers and barristers we work with offer IP
            litigation services.
          </p>
        </section>
        <section>
          ...
          <p>
            A patent is an exclusive right or monopoly granted by the
            Commonwealth for an invention, which is a product or a process that
            provides, in general, a new way of doing something or offers a new
            technical solution to a problem. A patent provides an enforceable
            legal right to prevent others from exploiting an invention.
          </p>
          ...
          <p>
            ...
            consent. To stop infringement of a patent, the patent must normally
            be enforced in a court. Conversely, a court can also declare a
          ...
          <ul>
            <li>
              be new (novel) when compared with public disclosures anywhere in
              the world, and
            </li>
            <li>
          ...
          <p>
            ...
            their generation. Accordingly, a vast range of products and
            processes can be protected by patents, including pharmaceutical
          ...
          <p>
            ...
            else, who will then become the new owner of the patent. Once a
            ...
            to the invention, which becomes available to commercial exploitation
            by others.
          </p>
          ...
          <p>
            ...
            duties, it would be prudent to put a written agreement in place
            before relevant work is done.
          </p>
          <h3>When should I file a patent application?</h3>
          <p>
            It is critically important to file a patent application before
            either publicly disclosing the details of the invention or
            conducting any commercial activities in respect of the invention.
            Any such actions will normally invalidate your right to pursue
            patent protection, although you should immediately consult your
          ...
          <p>
            ...
            date of filing of the complete application. However, the period can
            be shortened considerably if required. An{' '}
            <Link href="/innovation-patent-application">innovation patent</Link>{' '}
            typically issues within a period of one (1) to three (3) months.
            Note, however, that an innovation patent must be certified before
            legal action can be taken against a potential infringer.
            Certification requires substantive examination of the innovation
            patent which may take up to six (6) months. Importantly, if the
            innovation patent is found to be invalid during examination, it will
          ...
          <p>
            ...
            your invention (for the purposes of establishing that your invention
            is new). A provisional application is only temporary and an
            Australian or International patent application must be filed within
            12 months of lodging the provisional application for your
            application to retain its priority date.
          </p>
          ...
          <h3>
            When can I begin selling a product and/or begin seeking interest
            from others?
          </h3>
          <p>
            If a{' '}
            ...
            has been filed for the same invention, it is possible to use the
            term &ldquo;
            <Link href="/ip-glossary#patent-pending">patent pending</Link>
            &ldquo;. Only when a patent has actually been granted can a product
            be marked with &ldquo;Australian Patent Number xxxxxx&rdquo;. These
            terms are used to provide notice to third parties that a patent
            application has been filed in respect of an invention. Use of these
            symbols where no application has been made is prohibited and subject
            to fines.
          </p>
          ...
          <p>
            ...
            as soon as a new product, composition or process has been created,
            or when modifications have been made to a product or a process that
            will provide the manufacturer of that product or the user of that
            process with a marketing advantage over its competitors.
          </p>
          ...
          <p>
            ...
            patent protection for your invention and in accordance with the law
            of that country. An Australian patent provides protection only
            within Australia. If you want to apply for a patent in other
            countries, you generally have two choices:
          </p>
          <ol type="i">
          ...
          <p>
            ...
            the same effect as national applications filed in the countries of
            the PCT, and you can then choose to proceed in a selection of the
            140 countries at a later date. You will still need to meet the
            national requirements and pay the costs in each country, but these
          ...
          <p>
            ...
            circumstances where the inventor has disclosed their invention
            before applying for a patent— for example, when they have discussed
            it with a contractor without a confidentiality agreement— without
            affecting the validity of a subsequent patent application. In
            Australia, the grace period covers a period of no more than 12
            months before the filing date of the complete application.
            Importantly, however, the lack of a uniform grace period or grace
            period requirements around the world means that patent applications
          ...
          <p>
            ...
            &ldquo;
            <Link href="/ip-glossary#patent-application">
              patent application
            </Link>
            &rdquo; is the first document filed to start the protection process
            for a new idea. If the patent application passes through{' '}
            <Link href="/ip-glossary#examination">examination</Link>{' '}
            successfully, then we say that &ldquo;the patent is granted.&rdquo;
          </p>
          <p>
            ...
            suggests that applying for a patent is merely a matter of filling in
          ...
          <p>
            ...
            works, <Link href="/ip-glossary#design">registered designs</Link>{' '}
            are used to protect the look of designs that are being used
            commercially and patents protect function concepts or, put simply,
            the way things work.
          </p>
          <h3>What is a patent attorney?</h3>
          <p>
            A patent attorney provides representation and advice regarding
            patenting and related intellectual property matters, such as
            preparing and filing patent applications for inventions,
            representation in matters before the Patent Office, patent
            oppositions and advising in relation to infringement. A patent
            attorney has a degree or other qualification in a field of
            patentable technology (traditionally in science or engineering)
            coupled with further qualifications in the law and practice of
            intellectual property. <em>Section 200 of the Patents Act 1990</em>{' '}
            (Cth) provides that a communication between a registered patent
          ...
          <p>
            ...
            property rights. Patent lawyers are professionals who has
            successfully completed either the Board&apos;s examinations (Diploma
            in Law) or a NSW accredited law degree, as well as completed an
            accredited program of practical legal training. Patent lawyers
            typically work with barristers in the litigation of patent rights.
          </p>
          <p>
            On the other hand, a{' '}
            <Link href="/ip-attorney">patent attorney</Link> is a professional
            who has:
          </p>
          <ol>
            <li>an engineering or science degree;</li>
            <li>
              completed a group of topics prescribed by the Professional
              Standards Board relating to intellectual property rights; and
            </li>
            <li>
              worked under the supervision of a patent attorney for the
              prescribed period.
            </li>
          </ol>
          <p>
            ...
            managing patent applications through to patent grant. Patent
            attorneys can also handle{' '}
          ...
          <h3>
            Is a confidentiality agreement necessary between a patent attorney
            and a client?
          </h3>
          <p>
            ...
            intellectual property matters, and any record or document made for
            the purposes of such a communication, are privileged to the same
            extent as a communication between a solicitor and his or her client.
            That is, registered patent attorneys are under a strict obligation
            of confidentiality and a strict fiduciary requirement to use your
        ...
        <section>
          ...
          <p>
            ...
            your goods or services. Trade marks are an effective marketing tool
            to advertise your product and provide a unique and recognisable
          ...
          <p>
            ...
            trade mark is the only way to formally own a unique name or sign
            that distinguishes your products in the market and upon registration
            you will receive a formal Certificate of Registration of Trade Mark
            to prove ownership. This gives you the sole right to use and enjoy
          ...
          <p>
            ...
            matters, and any record or document made for the purposes of such a
            communication are privileged to the same extent as a communication
            between a solicitor and his or her client. Both patent and trade
            marks attorneys can provide representation and advice regarding
            designs and related intellectual property matters, such as design
            searching and opinions, preparing and filing design applications,
            representation in matters before the Designs Office, design
          ...
          <p>
            ...
            minute when an accountant asks what you intend to call your company
            or the name you need for printing packaging or the like. It&apos;s
            easy to fall into the trap of picking a descriptive name thinking
            this will tell clients what you do and make you easier to find. The
            downside to this is that you fall into the bucket with hundreds of
            other descriptive names chosen by your competitors. This means your
            name is ultimately not unique but generic and you risk trying to
            differentiate yourself based on price only.
          </p>
          <p>
            The starting point to{' '}
            <Link href="/choosing-a-brand-name">choose a good trade mark</Link>,
            a name that you can actually own, is to choose a name or sign that
            is not generic or descriptive for your goods or services. Made up
            words make great trade marks precisely because they do not directly
            describe the{' '}
          ...
          <p>
            ...
            they provide. An international tourist for example who is not aware
            of the brand is unlikely to know what they do without being told.
            This may seem counter intuitive, but who do you think will make the
            more profitable customer?Someone who values your brand as a premium
          ...
          <p>
            I know which client I want and the way to build that brand premium
            is by choosing a good trade mark. To do that don&apos;t pick a name
            that is descriptive or generic.
          </p>
          <p>
            ...
            advise you whether the name is likely to be accepted for
            registration.
          </p>
          <h3>
          ...
          <p>
            If your trade mark is distinctive and unique, the next step is to
            file a{' '}
            ...
            work with you to correctly identify the goods and services that
            should be included your trade mark application. The trade mark
            application process takes about 7 months in straightforward cases so
            it is important to file the application as soon as possible to
            ensure the earliest possible grant date. Once your trade mark has
            granted, it can be{' '}
            <Link href="/trade-mark-enforcement-options">enforced</Link>.
          </p>
          ...
          <p>
            ...
            of commercial interest. It&apos;s important to have a filing
            strategy in place for commercial expansion as having someone
            register your trade mark overseas before you get there can be
            problematic. Our attorneys can help by preparing a filing strategy
          ...
          <p>
            ...
            knowledge of the application process or requirements. Inexperience
            in preparing trade mark applications can incur unnecessary time and
            cost on compliance requirements and professional advice is essential
          ...
          <p>
            ...
            successfully using the registration to enforce your brand. These
            often only come to light when you seek professional advice when you
            wish to take action against an{' '}
            <Link href="/trade-mark-infringement">infringer</Link>. The
            following are examples of the types of deficiencies from incorrectly
            filed applications:
          </p>
          <ul>
            <li>
              the scope of registration may be too narrow meaning the
              registration does not provide adequate protection for your core
            ...
            <li>
              or the goods and/or services chosen may not be correctly
              identified;
            </li>
          ...
          <p>
            Baxter IP has extensive expertise and experience in the area of
            trade mark law and our trade mark attorneys have successfully
            registered hundreds of trade marks for our clients. Please{' '}
            <Link href="/sydney">contact us</Link> for a free and confidential
            no obligation consultation to discuss your trade mark needs.
          </p>
        </section>
      </div>
    </Layout>
