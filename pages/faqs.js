    ...
    <Layout>
      ...
      <section>
        ...
        <p>
          ...
          stop infringement of a patent, the patent must normally be enforced in
        ...
        <p>
          ...
          The patent owner may give permission, or license, to other parties to
          ...
          new owner of the patent. Once a patent expires, the protection ends,
          and an invention enters the public domain, that is, the owner no
        ...
        <p>
          A&nbsp;<Link href="/provisional-patents">standard patent</Link>
          &nbsp;usually issues within a period of between two (2) to five (5)
          years from the date of filing of the complete application. However,
          the period can be shortened considerably if required. An&nbsp;
          ...
          legal action can be taken against a potential infringer. Certification
        ...
        <p>
          ...
          is new). A provisional application is only temporary and an Australian
          or International patent application must be filed within 12 months of
        ...
        <p>
          ...
          “patent application filed”. Once a complete application has been filed
          for the same invention, it is possible to use the term “
          <Link href="/ip-glossary#patent-pending">patent pending</Link>“. Only
          when a patent has actually been granted can a product be marked with
          “Australian Patent Number xxxxxx”. These terms are used to provide
          notice to third parties that a patent application has been filed in
        ...
        <p>
          ...
          &nbsp;as soon as a new product, composition or process has been
          created, or when modifications have been made to a product or a
        ...
        <ol type="i">
          ...
          <li>
            file a single&nbsp;
            <Link href="/pct-patent">international application</Link>&nbsp;via
            what is referred to as the&nbsp;
            <Link href="/ip-glossary#pct-patent-cooperation-treaty">
              Patent Cooperation Treaty (PCT)
            </Link>
            &nbsp;of which around 140 countries, including Australia, are
            members.
          </li>
        </ol>
        <p>
        ...
        <p>
          ...
          ” is the first document filed to start the protection process for a
          new idea. If the patent application passes through&nbsp;
          <Link href="/ip-glossary#examination">examination</Link>
          &nbsp;successfully, then we say that “the patent is granted.”
        </p>
        <p>
          In the United States, the equivalent terminology used is that ‘the
          patent has issued’. Colloquially, people talk about patent
          registration because the word registration validly applies to the
          granting of&nbsp;
          ...
          “patent registration” does cause confusion because it suggests that
        ...
        <p>
          ...
          used to protect functional concepts (directly) – this is where patents
          come in. A patent is a type of intellectual property right that
          encapsulates an idea in words and stops third parties from copying the
          idea. Copyright is not normally an effective form of protection for
          new developments in&nbsp;
          <Link href="/specialisations/software-patents">
            computer software
          </Link>
          &nbsp;or website applications – these are best protected by patents.
        ...
        <p>
          ...
          <em>Section 200 of the Patents Act 1990</em>&nbsp;(Cth) provides that
          a communication between a registered patent attorney and the
          attorney’s client in intellectual property matters, and any record or
          document made for the purposes of such a communication, are privileged
        ...
        <p>
          ...
          completed either the Board’s examinations (Diploma in Law) or a NSW
          accredited law degree, as well as completed an accredited program of
          practical legal training. Patent lawyers typically work with
          barristers in the litigation of patent rights.
        </p>
        <p>
          On the other hand, a&nbsp;
          <Link href="/ip-attorney">patent attorney</Link>&nbsp;is a
        ...
        <p>
          ...
          <Link href="/provisional-patents">patent applications</Link>&nbsp;and
          in managing patent applications through to patent grant. Patent
        ...
        <p>
          ...
          registered patent attorney and the attorney’s client in intellectual
          property matters, and any record or document made for the purposes of
          such a communication, are privileged to the same extent as a
          communication between a solicitor and his or her client. That is,
      ...
      <section>
        ...
        <p>
          ...
          numbers, names, brands, colour, shape, images, smells or sounds.&nbsp;
          A trade mark is the only way to formally own a unique name or sign
          that distinguishes your products in the market and upon registration
          you will receive a formal Certificate of Registration of Trade Mark to
        ...
        <p>
          ...
          related intellectual property matters, such as&nbsp;
          ...
          attorney and the attorney’s client in intellectual property matters,
          and any record or document made for the purposes of such a
        ...
        <p>
          ...
          the name you need for printing packaging or the like. It’s easy to
          fall into the trap of picking a descriptive name thinking this will
        ...
        <p>
          ...
          by choosing a good trade mark. To do that don’t pick a name that is
          descriptive or generic.
        </p>
        <p>
          If you aren’t sure whether your name is descriptive or generic, speak
        ...
        <p>
          ...
          If you want protection for your trade mark overseas you will need
          to&nbsp;
          ...
          strategy in place for commercial expansion as having someone register
          your trade mark overseas before you get there can be
        ...
        <p>
          Ultimately, only a small number of “do-it-yourself” applications are
          successful. Most are abandoned due to insufficient knowledge of the
          application process or requirements. Inexperience in preparing trade
          mark applications can incur unnecessary time and cost on compliance
          requirements and professional advice is essential for a positive
          outcome.
        </p>
        <p>
          Should someone&nbsp;
        ...
        <p>
          ...
          <Link href="/sydney">contact us</Link>&nbsp;for a free and
          confidential no obligation consultation to discuss your trade mark
          needs.
        </p>
      </section>
    </Layout>
