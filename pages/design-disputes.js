...
export default function DesignDisputes() {
  return (
    <Layout>
      ...
      <p>
        The two- or three-dimensional appearance of an article can be protected
        through <Link href="/registered-designs">design registration</Link>.
        Design registration grants the owner a 10 year monopoly on the visual
        appearance of a product, with the registration being renewed five years
        into the lifetime of the registered design. Failure to renew
      ...
      <ul>
        ...
        <li>
          distinctive, meaning that it should not look substantially similar in
          appearance.
        </li>
      </ul>
      <p>
        ...
        and Australian Consumer Law on the basis of the good will established by
        the reputable use of the registered design.
      </p>
      ...
      <p>
        ...
        application must be made jointly and under all the names of the parties
        involved.
      </p>
      ...
      <p>
        ...
        examination in contrast to the formalities examination for registration.
        To be certified, the Designs Office will check if the design is new and
        not offensive (containing graphic words or images). The design should
        also be free of any protected emblems (such as flags and signets).
      </p>
      ...
      <p>
        ...
        written with utmost care, because if the claims in the letter are proven
        groundless, the accused may be awarded costs. Conversely, if
      ...
      <p>
        Upon receiving a cease and desist letter, one may be involved in dispute
        settlement through alternative dispute resolution routes, such as
        negotiation, mediation or arbitration. An application may be sought to
        have the existing registered design revoked by proving that the design
        being infringed should not have been registered in the first place. Any
        party can request IP Australia re-examine a registered design provided
        that they have information on relevant designs used prior to the filing
        date of the contested registered design.
      </p>
