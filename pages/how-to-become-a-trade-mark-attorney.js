  ...
  return (
    <Layout>
      ...
      <p>
        ...
        <Link href="/madrid-protocol-application">Madrid protocol</Link>. Unlike
        patent applications, trade mark applications can be filed by anyone;
        however, registration as a trade mark attorney grants certain benefits,
        such as the right to be called a &quot;trade mark attorney&quot; or
        &quot;trade mark agent&quot; and conduct business as so.
      </p>
      <h2>Qualifications of a trade mark attorney</h2>
      <p>
        To become a registered trade mark attorney and be listed in the official
        Australian Register of Trade Mark Attorneys, the individual must possess
        several competencies in accordance to the standards set by the
        Professional Standards Board of Trade Mark and Patent Attorneys
      ...
      <ul>
        ...
        <li>
          an overseas qualification that the Board deems equivalent to a Level 5
          AQF qualification
        </li>
      </ul>
      <p>
        While it is not a requirement, a degree in law may be beneficial in the
        practise of trade marks attorneys.
      </p>
      <p>
      ...
      <p>
        ...
        course groups are sufficient to be eligible to practise as a trade mark
        attorney.
      </p>
      <ul>
      ...
      <p>
        ...
        courses offered by several prescribed tertiary institutions or applying
        for exemptions to the Board on the basis of having previously taken the
        equivalents of these topics.
      </p>
      <h3>Personal qualifications</h3>
      <p>
        A trade mark attorney is tasked to function according to law and act in
        the best interest of their client. Thus, it is of utmost importance that
        trade mark attorney be
      </p>
      <ul>
      ...
      <h2>Takeaway/s</h2>
      <p>
        A person must have a spotless character, sufficient technical knowledge,
        and the complete educational requirements to be able to become an
        Australian trade mark attorney. Even so, the field is starting to become
        extremely competitive with applicants having identical or similar
        qualifications, so differences in experience and work environment may
        spell your success or failure in the field.
      </p>
    </Layout>
  )
}
