...
export default function ContactUs({ office }) {
  ...
  return (
    <>
    <Head>
        <title>{`Contact our Baxter IP Melbourne Patent & Trade Mark attorneys`}</title>
        <meta
          name="description"
          content={
            'Call +61 3 9602 2288 to talk with a patent or trade mark attorney at our Melbourne office to discuss intellectual property queries today.'
          }
        />
      </Head>
