...
export default function ContactUs({ office }) {
  ...
  return (
    <>
     <Head>
        <title>{`Contact our Baxter IP Brisbane Patent & Trade Mark attorneys`}</title>
        <meta
          name="description"
          content={
            'Call +61 7 3155 7970 to talk with a patent or trade mark attorney at our Brisbane office to discuss intellectual property queries today.'
          }
        />
      </Head>
