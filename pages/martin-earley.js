  ...
  return (
    <Layout>
      ...
      <p>
        ...
        ,&nbsp;
        <Link href="https://www.baxterip.com.au/specialisations/physics-and-optical-patents">
          physics
        </Link>
        , nanotechnology and engineering innovations allow him to cut through
        complexity.
      </p>

      <p>
        Martin started his career as an examiner at IP Australia (the Australian
        Patent Office). His expertise spans technologies as diverse as&nbsp;
        ...
        ,&nbsp;
        <Link href="https://www.baxterip.com.au/specialisations/consumer-product-patents">
          consumer goods
        </Link>
        ,&nbsp;
        <Link href="https://www.baxterip.com.au/specialisations/software-patents">
        ...
        , telecommunication,&nbsp;physics&nbsp;and nanotechnology. His talent
        for detailed conceptual analysis and practical commercial advice
        delivers ongoing value for all his clients.
      </p>
