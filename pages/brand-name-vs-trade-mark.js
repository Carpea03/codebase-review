  ...
  return (
    <Layout>
      <Head>
        ...
        />
        <link rel="canonical" href="/brand-name-vs-trade-mark" />
      </Head>
      ...
      <p>
        ...
        However, the difference between brand name and trade mark lies in their
        function. A brand name may be a company name or a name ascribed to a
        particular product or service. It is what the company uses to represent
        its goods and services and what consumers use to refer back these goods
        and services to their source. A{' '}
      ...
      <p>
        ...
        product (Vegemite) or a product variant (Coke Zero), or a service (Uber
        Eats), among others. A well-known, recognisable brand name induces
      ...
      <p>
        ...
        <Link href="/trade-mark-registration-benefits">protection</Link> that an
        unregistered brand name cannot. After application and upon approval by
        the Trade Marks Office, a trade mark is registered into the national
      ...
      <p>
        ...
        legislated enforcement option available for each. When left unprotected,
        a brand name that has acquired a good reputation may become a target of
        counterfeiters who attempt to benefit from the established goodwill
        toward the brand name by selling subpar counterfeit items or using their
        own confusingly similar brand that people may mistake for the original
        brand. Unregistered brand names and logo marks can be protected by the
        common-law tort of passing off, but the proceedings may be costly and
        lengthy. In addition, expansion, outsourcing production or distribution
