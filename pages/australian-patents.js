    ...
    <Layout>
      ...
      <ul>
        ...
        <li>
          ...
          step, it must be “ascertained, understood and regarded as relevant” by
          the PSA.
        </li>
        <li>
          In a recent revision to the Australian patent examination criteria in
          2010, the ‘obvious to try’ question can be asked when assessing
          Inventive Step. That it, “would the PSA directly be led as a matter of
          course to try the claimed invention in the expectation that it might
          well produce a solution to the problem?”
        </li>
        <li>
