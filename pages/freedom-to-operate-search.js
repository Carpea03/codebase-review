  ...
  return (
    <Layout>
      ...
      <p>
        ...
        patents or <Link href="/provisional-patents">patent applications</Link>{' '}
        (which would upon grant) that are live and that pose an infringement
        risk. Your product or proposed product is then analysed against the
        claims of the patents that have been identified by the patent clearance
        search.
      </p>
      ...
      <ol>
        <li>
          ...
          patent examiners miss important items of prior art that either alone,
          or in combination with other prior art documents, would invalidate or
          limit the claims of the granted patent. Furthermore, patent examiners
        ...
        <li>
          ...
          <Link href="/provisional-patents">patent application</Link> that is of
          interest to the patent owner of the third-party patent, there is also
          the possibility of cross-licensing the two patent applications. This
          has become quite a popular solution employed by large companies to
          avoid <Link href="/patent-litigation">patent litigation</Link>, but
          this approach is useful for all companies.
        </li>
        <li>
          ...
          <Link href="/patent-attorney">patent attorney</Link> can help you with
