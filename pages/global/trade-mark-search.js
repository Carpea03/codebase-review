  ...
  return (
    <Layout>
      ...
      <p>
        ...
        earlier rights. If infringement is found, you may end up paying monetary
        compensation to the party being infringed and doing costly rebranding.
        You may also incur charges if your trade mark receives an Examination
        Report based on a prior trade mark application/registration and you
        require professional help to respond to this report. Alternatively, you
        may also end up having your resources drained if you have to go through
        an opposition process. Such occurrences may be avoided if a thorough
        trade mark check is conducted in the preliminary stages.
      </p>
      ...
      <p>
        ...
        or before filing a trade mark application. If your trade mark
        application is defined incorrectly, it may be rejected or if accepted,
        offer you inadequate protection. This could result in missed business
        ...
        before you apply for registration. Based on the results of the search,
        you may wish to reconsider the trade mark or even the entire brand to be
        able to obtain trade mark registration.
      </p>
      ...
      <p>
        A trade mark attorney can assist you by conducting trade mark searches
        in national and foreign trade mark registries and may provide guidance
        in relation to common-law marks in use in the market, which are not
        included in the government trade mark registers. As a part of their
        search, trade mark attorneys formulate query prompts utilising other
        possible forms of the trade marks, such as deliberately misspelled
        words, and can also check for linguistic suitability of your mark in
        foreign markets (like translations and transliterations for China). Of
        course, no system is 100% infallible, but these searches are typically
        customised to suit your proposed trade mark and can minimise the risk of
        your mark infringing on a registered trade mark or an established
        unregistered trade mark in the market.
      </p>
        ...
        <table>
          <tbody>
            ...
            <tr>
              ...
              <td>
                Descriptive trade marks, which describe a particular good or
                service can be granted protection to a limited capacity (for
                example: soft in relation to cotton products are not
                registrable, whereas a &ldquo;Soft&rdquo; figurative trade mark
                is registered in relation to cosmetics). Meanwhile, generic
                trade marks, which use the actual product or service, cannot be
                protected at all. By conducting a search, a trade mark attorney
                will be able to assess the strength and level of distinctiveness
                of your mark.
              </td>
            </tr>
            <tr>
              ...
              <td>
                ...
                that possible trade mark infringement can cause your business.
              </td>
            </tr>
            <tr>
              ...
              <td>
                ...
                whether to purchase the domain or other course of action.
              </td>
            </tr>
            <tr>
              ...
              <td>
                ...
                solicitor can issue a Cease and Desist letter to another party;
                otherwise, groundless threats may result in incurred damages
        ...
        <table>
          <tbody>
            <tr>
              ...
              <td width="85%">
                Trade marks are distinctly associated to the goods and services
