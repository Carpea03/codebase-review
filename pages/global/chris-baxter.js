...
export default function ChrisBaxter() {
  return (
    <Layout>
      <Head>
      ...
      <p>
        ...
        spanning, in particular: medtech, defence, software and aerospace
        inventions.
      </p>
      ...
      <p>
        ...
        draws on his experience working in-house as a patent attorney with one
        of Australia&rsquo;s largest medical devices companies – ResMed, in
