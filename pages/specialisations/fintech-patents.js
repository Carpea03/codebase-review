...
export default function FintechPatents() {
  return (
    <Layout>
      <Head>
        <title>
          Fintech patents | Financial technology patent attorney experts at
          Baxter IP
        </title>
        <meta
          name="description"
      ...
      <div>
        <h1>Fintech patents</h1>
        <p>
          Fintech encompasses all manner of{' '}
          <Link href="https://www.baxterip.com.au/specialisations/software-patents">
            developed software and apps
          </Link>{' '}
          used in the finance sector, as well as the infrastructure used to run
          these programs. This includes banking, insurance, point-of-sale,
          security and transaction technologies, amongst others. In truth, the
          boundaries of what may/may not be referred to as Fintech are hard to
          define and legislation of what is considered patentable is similarly
          in flux. Thus, Fintech patent applications should be carefully
          considered and drafted based on a clear understanding of current
          software patenting law in the jurisdictions of relevance.
        </p>
        <p>
          Probably the most famous example of a Fintech patent is the 1-Click
          purchase technology developed by Amazon. Whilst conceptually, the
          technology is not complex, it bypasses several processes in purchasing
          items online, making purchasing easier for Amazon&rsquo;s customers.
          Another example of a Fintech application is the use of biometrics for
          mobile payment apps, as in the case of Apple&rsquo;s Touch ID to make
          purchases using Apple&rsquo;s mobile wallet (Apple Wallet),
          application store (App Store), and multimedia store (Itunes).
        </p>
        <h3>Benefits and challenges of patenting financial technology</h3>
        <p>
          In the exponentially growing Fintech market, a Fintech patent is
          important to maximise the commercial value and establish protection
          for investment in your innovation. In addition, a Fintech patent can
          enable the patent owner to license the application to other parties.
          Even banks and traditional financial institutions have become
          increasingly welcoming of Fintech and are filing patent applications
          for their own Fintech infrastructure. The main challenge in filing a
          Fintech patent is in the framing of the invention. Subject matter
          objections can arise where a patent application fails to show that the
          innovation is more than an abstract idea.
        </p>
        <p>
          Another difficulty in filing a Fintech patent is the 18-month shadow,
          what do we mean? Patent information is only disclosed publicly by the
          patent office at 18 months after the priority date. Therefore, it is
          possible and especially in rapidly developing markets like Fintech,
          that an application with similar or identical concept may have been
          filed prior and the applicant would not know about it until it is
          published 18 months after it is filed.
        </p>
        <h3>Examples of granted fintech patent applications</h3>
        <table>
          <tbody>
            <tr>
              <th>Mobile banking apps</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2001241977"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2001241977"
                      target="_blank"
                      rel="noopener noreferrer">
                      AU Patent # 2001241977
                    </Link>
                  </dt>
                  <dd>Multifunctional mobile banking system</dd>
                </dl>
                <p>
                  <small>Euronet Worldwide, Inc</small>
                </p>
              </td>
            </tr>
            <tr>
              <th>Online payment portals</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="US Patent # 2013205573 etc."
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2013205573"
                      target="_blank"
                      rel="noopener noreferrer">
                      US Patent # 2013205573 etc.
                    </Link>
                  </dt>
                  <dd>Payment application framework</dd>
                </dl>
                <p>
            ...
            <tr>
              <th>Security and identity verification</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # US8782775B2"
                      href="https://patents.google.com/patent/US8782775B2/en?oq=US8782775B2"
                      target="_blank"
                      rel="noopener noreferrer">
            ...
            <tr>
              <th>Loan management applications</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2009202196"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2009202196"
                      target="_blank"
                      rel="noopener noreferrer">
                  ...
                  <dd>
                    Loan portfolio management and automatic loan repayment
                    method and system
                  </dd>
                </dl>
                <p>
                  <small>Advanced Merchant Payments, Ltd</small>
                </p>
              </td>
            </tr>
            <tr>
              <th>Block chain and cryptocurrency</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2018100999"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2018100999"
                      target="_blank"
                      rel="noopener noreferrer">
                  ...
                  <dd>
                    Integration of Cryptocurrency Splitting Technology, Highly
                    Scalable Blockchain Network and Mirror Advertising
                    Technology for transparency of Business Operations and
                    Taxation
                  </dd>
                </dl>
                <p>
                  <small>
                    Cherkas, Ruslan MR; Pavlenko, Ivan MR; Sashin, Sergey MR;
                    Tcherkas, Dmitri DR; Vasilenko, Alex MR; Williams, Elise MRS
                  </small>
                </p>
              </td>
            </tr>
            <tr>
              <th>Insurance applications</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2011101529"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2011101529"
                      target="_blank"
                      rel="noopener noreferrer">
                      AU Patent # 2011101529
                    </Link>
                  </dt>
                  <dd>A Method of Providing Insurance</dd>
                </dl>
                <p>
                  <small>IUG Asset Management Limited</small>
                </p>
              </td>
            </tr>
            <tr>
              <th>Loan calculators, personal financing apps</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2018101796"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2018101796"
                      target="_blank"
                      rel="noopener noreferrer">
                  ...
                  <dd>
                    An Online Home Loan Comparison Calculator with added
                    functionality, allowing the user to ascertain the net effect
                    of adding the cost of a Solar PV System to the original home
                    loan amount. The Solar Home Loan Calculator allows the user
                    to compare 2 different loan amounts with 2 varying or equal
                    interest rates, showing a net loss or gain in terms of loan
                    payments. The calculator also allows the user to input the
                    electricity savings generated by the Solar PV System in
                    dollar terms, as extra loan repayments, illustrating the
                    reduction in overall home loan interest payable, loan term
                    &amp; LVR
                  </dd>
                </dl>
                <p>
                  <small>Xenara Financial Pty Ltd</small>
                </p>
              </td>
            </tr>
          </tbody>
        </table>
        <h2>The Baxter IP approach in filing fintech patents</h2>
        <p>
          Baxter IP has been continuously awarded in the field of&nbsp;
          <Link href="https://www.baxterip.com.au/specialisations/software-patents">
            software patents
          </Link>
          &nbsp;with&nbsp;
          ...
          &nbsp;– we are highly experienced in this field. Our patent attorneys
          provide careful counsel, listening carefully to your ideas and
          providing recommendations, not just options. In drafting fintech
          patent applications, your patent attorney will emphasise the process
          of delivering the outcomes of the application in the real-world
          context so as to minimise the possibility that the application will be
          considered by the examiner as abstract.
        </p>
        <p>
        ...
        <h3>Examples of fintech patent applications filed through Baxter IP</h3>
        <ol>
          <li>
            <Link
              title="AU Patent #2016309943"
              href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2016309943">
              <i>AU Patent #2016309943</i>
            </Link>
            &nbsp;–&nbsp;
            <strong>
              A computer implemented method for processing a financial
              transaction and a system therefor.&nbsp;
            </strong>
            Identitii Pty Ltd
          </li>
          <li>
            <Link
              title="AU Patent #2014904037"
              href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2014904037">
              <i>AU Patent #2014904037</i>
            </Link>
            &nbsp;–&nbsp;
            <strong>Electronic payment system &amp; method.&nbsp;</strong>
            Spectrum Message Services Pty Ltd
          </li>
          <li>
            <Link
              title="AU Patent #2017100687"
              href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2017100687">
              <i>AU Patent #2017100687</i>
            </Link>
            &nbsp;–&nbsp;
            <strong>
              A computer system and a computer implemented method for management
              of a mortgage obtained on a property.&nbsp;
            </strong>
            Mifsud, Karl Norman
          </li>
          <li>
      ...
      <div>
        <h2>What are the key regions for fintech patents?</h2>
        <p>
          <svg
            id="svg-replaced-7"
            ...
            <polygon
              fill="#d6d6d6"
              points="751.33 391.38 751.75 392.3 753.23 392.69 754.04 391.98 753.5 391.28 751.33 391.38"></polygon>
            <polygon
              fill="#d6d6d6"
            ...
            <polygon
              fill="#d6d6d6"
              points="726.83 403.32 729.28 402.51 726.65 401.23 723.42 400.84 722.64 399.45 718.67 398.41 718.19 399.3 714.08 399.09 713.78 398.31 712.89 398.14 711.16 397.31 708.56 397.18 707.09 399.23 709.06 399.39 709.43 400.32 713.34 401.2 714.24 400.94 715.81 401.15 718.3 401.97 720.3 402.36 722.53 402.52 724.47 402.46 726.83 403.32"></polygon>
            <polygon
              fill="#d6d6d6"
              points="755.65 381.13 755.5 379.97 754.79 380.74 754.36 382.44 754.99 385.17 755.86 386.51 756.46 386.26 755.58 385.14 755.9 383.85 757.01 384.05 757.13 382.19 756.92 381.31 755.65 381.13"></polygon>
            <polygon
              fill="#d6d6d6"
              points="740.02 406.55 740.14 405.96 739.39 405.3 738.27 404.64 736.27 405.07 739.12 406.58 740.02 406.55"></polygon>
            <polygon
              fill="#d6d6d6"
              points="768.76 397.72 768.97 399.34 770.07 397.88 770.09 396.85 769.6 396.23 769.15 396.95 768.76 397.72"></polygon>
            <polygon
              fill="#d6d6d6"
              points="744.4 403.1 744.72 401.91 742.8 402.69 741.38 402.85 740.03 402.21 738.32 402.66 738.33 403.45 741.18 403.71 744.4 403.1"></polygon>
            <polygon
              fill="#d6d6d6"
              points="781.23 389.74 779.64 388.98 777.8 388.24 775.9 388.24 773.43 389.52 771.64 391.79 769.42 390.51 768.83 387.06 768.48 386.28 765.04 385.41 763.94 386.1 761.04 386.62 761.96 387.67 763.87 388.06 764.72 389.33 767.86 389.34 768.04 389.9 766.51 389.87 764.2 390.63 765.84 391.68 765.84 392.61 766.33 393.39 767.16 393.19 767.79 392.15 771.01 394.13 772.78 394.3 776.94 396.12 777.98 397.92 778.54 400.25 777.18 400.85 776.27 402.6 778.99 402.53 779.51 401.92 781.7 402.35 783.61 404.12 783.57 397.11 783.53 390.15 781.23 389.74"></polygon>
            <polygon
              fill="#d6d6d6"
              points="734.76 402.49 733.98 401.92 733.41 402.69 732.23 402.7 731.5 403.94 732.65 403.96 734.14 403.67 736.62 403.23 736.08 402.31 734.76 402.49"></polygon>
            <polygon
              fill="#d6d6d6"
              points="737.04 387.5 736.73 389.19 735.84 390.59 736.51 392.06 737.41 392.07 737.74 394.13 737.13 396.1 738.05 396.72 739.41 396.41 739.32 393.35 739.14 390.86 740.57 390.21 740.41 392.29 741.96 393.55 741.68 394.37 742.22 394.96 744.32 394.14 743.28 395.89 744.12 396.64 745.27 396.01 745.28 394.6 743.36 392.14 743.75 391.4 741.72 388.67 743.61 387.85 744.54 386.6 745.48 386.91 745.65 385.93 741.65 386.65 740.5 387.62 738.57 385.72 738.88 384.11 740.75 383.8 744.33 383.69 746.39 384.11 748.01 383.69 749.73 381.58 749.36 381.11 747.24 382.66 744.77 382.75 742.06 382.45 740.39 381.82 738.57 383.41 738.12 384.29 737.04 387.5"></polygon>
            <polygon
              fill="#d6d6d6"
            ...
            <polygon
              fill="#d6d6d6"
              points="751.2 404.09 753.43 403.15 754.22 402.57 753.41 402.3 752.74 402.57 751.24 402.64 749.4 403.13 749.15 403.63 749.36 404.06 749.4 404.72 751.2 404.09"></polygon>
            <polygon
              fill="#d6d6d6"
        ...
        <section className="bg-white dark:bg-gray-900">
          <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-xl">
            <h4 className="mb-8 lg:mb-16 text-3xl font-extrabold tracking-tight leading-tight text-center text-gray-900 md:mb-8 lg:mb-16 dark:text-white md:text-4xl">
              Some of our fintech clients include:
            </h4>
