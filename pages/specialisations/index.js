      ...
      <div>
        <section className="bg-white dark:bg-gray-900 format mx-auto">
          ...
          <p>
            ...
            all of whom are patent industry experts, you can benefit from
          ...
          <div className="max-w-2xl grid gap-8 lg:grid-cols-2 not-format">
            <a
              ...
              <span className="w-full">Software, apps & computer patents</span>
              <svg
            ...
            <a
              ...
              <span className="w-full">Consumer product patents</span>
              <svg
                className="ml-3 w-6 h-6"
                fill="currentColor"
                viewBox="0 0 20 20"
            ...
            <a
              ...
              <span className="w-full">Fintech patents</span>
              <svg
                className="ml-3 w-6 h-6"
                fill="currentColor"
                viewBox="0 0 20 20"
            ...
            <a
              ...
              <span className="w-full">Medical device patents</span>
              <svg
                className="ml-3 w-6 h-6"
                fill="currentColor"
                viewBox="0 0 20 20"
          ...
          <ol>
            ...
            <li>
              Your patent specialist attorneys will be able to identify
              potential points of novelty or inventiveness more easily.
            </li>
            <li>
              Your patent industry experts will be able to identify how a
              competitor might attempt to circumvent your patent claims more
              easily in order to defend against this.
            </li>
            <li>
              With their patent technology specialisation, your patent attorneys
              will be able to expand the scope of your patent claims with
              logical variations.
            </li>
            <li>
              They may be able to provide you with some contacts in the industry
              or other commercial advice.
            </li>
          </ol>
          <p>
