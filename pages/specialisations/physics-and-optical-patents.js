  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name="description"
          content="File your patents involving physics and optical engineering innovations. Talk to our physics and optical engineering patent experts at Baxter IP."
        />
        <link
          rel="canonical"
      ...
      <div>
        ...
        <p>
          ...
          communications have their roots in developments in the fields of
          physics and optical engineering. One of the newest fields of physics
          to be commercialised is quantum mechanics and significant leaps
          forward in computational power have already been made in quantum
          computing. Incidentally, one of the leaders in this field, Silicon
          Quantum Computing, is locally based and a spin-out company from UNSW.
        </p>
        <p>
          Our{' '}
          ...
          have backgrounds in physics enabling us to speak the same language as
          researchers and to better translate your work into patent assets. We
          have great depth of experience and work closely with university
          partners and other commercial enterprises to help protect innovations
          in the field of physics.
        </p>
        <h2>What is or is not patentable in the physics industry?</h2>
        <p>
          A common thread throughout patent law worldwide is that fundamental
          principles of physics are not patentable in themselves. However, the
          practical application of those same fundamental principles to solve
          technological, real-world problems lie squarely in the realm of
          patentable subject matter.
        </p>
        <p>
          For example, Einstein&rsquo;s famous principle relation governing the
          inter-relationship between mass and energy E=mc<sup>2</sup>, in and of
          itself would not be patentable in isolation. However, the many
          practical applications of this relation, such as, nuclear reactors, CT
          &amp; PET scanners in hospitals or the humble smoke detector are all
          eminently patentable applications of nuclear physics and quantum
          mechanics and ultimately, E=mc<sup>2</sup>.
        </p>

        <h3>Benefits and challenges in filing physics patent applications</h3>
        <p>
          For researchers, there is a professional requirement to publish papers
          on their findings. It is important to file a patent application before
          disclosing an invention publicly via a paper or presentation in order
          to establish ownership and a competitive edge over other start-ups in
          the market who may be developing similar concepts concurrently. It is
          also important to speak with a patent attorney who will ensure the IP
          protection sought aligns with commercial objectives.
        </p>
        <h3>Examples of granted physics and optical engineering patents</h3>
        <table>
          <tbody>
            <tr>
              <th>
              ...
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2017201452"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2017201452"
                      target="_blank"
                      rel="noopener noreferrer">
                      AU Patent # 2017201452
                    </Link>
                  </dt>
                  <dd>Laser video endoscope</dd>
                </dl>
                <p>
                  <small>Beaver-Visitec International, Inc.</small>
                </p>
              </td>
            </tr>
            <tr>
              <th>Nuclear reactor devices</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2017204050"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2017204050"
                      target="_blank"
                      rel="noopener noreferrer">
                      AU Patent # 2017204050
                    </Link>
                  </dt>
                  <dd>
                    Nuclear magnetic resonance (NMR) logging tool calibration
                  </dd>
                </dl>
                <p>
            ...
            <tr>
              <th>Hydration sensor systems and applications</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2013300083"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2013300083"
                      target="_blank"
                      rel="noopener noreferrer">
                      AU Patent # 2013300083
                    </Link>
                  </dt>
                  <dd>
                    Thermal diagnostic for single-crystal process fluid pressure
                    sensor
                  </dd>
                </dl>
                <p>
                  <small>Rosemount, Inc.</small>
                </p>
              </td>
            </tr>
            <tr>
              <th>Display systems</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2019100016"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2019100016"
                      target="_blank"
                      rel="noopener noreferrer">
                      AU Patent # 2019100016
                    </Link>
                  </dt>
                  <dd>LED display</dd>
                </dl>
                <p>
                  <small>Unilumin Group Co., Ltd.</small>
                </p>
              </td>
            </tr>
          </tbody>
        ...
        <h2>
          The Baxter IP approach to filing physics and optical engineering
          patents
        </h2>
        <p>
        ...
        <h3>
          Examples of physics and optical engineering patent applications filed
          through Baxter IP
        </h3>
        <ol>
          <li>
            <Link
              title="AU Patent #2018250414"
              href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2018250414">
              <i>AU Patent #2018250414</i>
            </Link>
            &nbsp;–&nbsp;
            <strong>Resin lens and method for producing the same.&nbsp;</strong>
            Shandong Efirm Biochemistry and Environmental Protection Co., Ltd.
          </li>
          <li>
            <Link
              title="AU Patent #2017304227"
              href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2017304227">
              <i>AU Patent #2017304227</i>
            </Link>
            &nbsp;–&nbsp;
            <strong>
          ...
          <li>
            <Link
              title="AU Patent #2014328465"
              href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2014328465">
              <i>AU Patent #2014328465</i>
            </Link>
            &nbsp;–&nbsp;
            <strong>
              A display system for ambient light discrimination.&nbsp;
            </strong>
            Hutchinson, William; Mino, Nelson; Thomas Electronics of Australia
            Pty Ltd
          </li>
          <li>
            <Link
              title="PCT/AU2013/001234"
              href="https://patents.google.com/patent/WO2014063198A1">
              <i>PCT/AU2013/001234</i>
            </Link>
            &nbsp;–&nbsp;<strong>A Radioisotope Concentrator</strong>
          </li>
          <li>
            <Link
              title="AU Patent #2014208276"
              href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2014208276">
              <i>AU Patent #2014208276</i>
            </Link>
            &nbsp;–&nbsp;
            <strong>
              Light emitting diode (LED) backlighting source.&nbsp;
            </strong>
            Spicon Industries Pty Ltd
          </li>
          <li>
            <Link
              title="AU Patent #2010303747"
              href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2010303747">
              <i>AU Patent #2010303747</i>
            </Link>
            &nbsp;–&nbsp;<strong>Modular heat exchanger.&nbsp;</strong>Lockheed
            Martin Corporation
          </li>
        </ol>
      </div>
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6 not-format">
        <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
            Our physics and optical engineering industry experts
          </h2>
        </div>
        <p>
          Many of Baxter IP&rsquo;s patent attorneys have more than 10
          years&rsquo; experience each in drafting and prosecuting patent
      ...
      <div>
        ...
        <p>
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg">
            <title>
              What are the key regions for physics and optical engineering
              patents?
            </title>
            ...
            <polygon
              fill="#d6d6d6"
              points="493.46 260.71 493.23 262.57 493.71 262.86 494.33 262.78 494.45 261.34 494.02 260.59 493.46 260.71"></polygon>
            <polygon
              fill="#d6d6d6"
            ...
            <text
              ...
              fill="#011d3b"
              font-size="19.31"
              transform="translate(793.28 310)">
              Japan
            </text>
            <text
              font-weight="500"
              ...
              fill="#011d3b"
              font-size="19.31"
              transform="translate(687.65 294.39)">
              Ko
            ...
            <text
              ...
              fill="#011d3b"
              font-size="19.31"
              transform="translate(125.38 259.17)">
              Canada
            </text>
            <path
