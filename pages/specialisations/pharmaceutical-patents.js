    ...
    <Layout>
      ...
      <div>
        ...
        <p>
          ...
          process for making a chemical substance or mixture, a product yielded
          by a particular process or a particular method of using a product. One
          of the earliest patented chemical processes, in fact the first US
          patent, was awarded to Samuel Hopkins in 1790 for his process to
          produce potash.
        </p>
        <p>
          Biotechnology involves harnessing biological systems, substances and
          processes to improve daily life. Some of these systems have been
          utilised for centuries, even before the modern patent system arose.
          One such example is the use of yeast in brewing alcohol. Biotechnology
          patents are often awarded to the novel use of known systems to yield a
          new outcome or for modification of such systems to improve their
          performance. One of the earliest and most notable patents awarded in
          the biotechnology field was awarded to Louis Pasteur, who developed a
          way to heat-treat milk and several fruit juices so as to extend their
          shelf life, by destroying pathogens.
        </p>
        <p>
          Pharmaceutical inventions can present features of both chemical and
          biotechnology innovations. Useful drugs can originate from new
          approaches to extracting naturally occurring substances, or may be
          modifications of natural substances, or may be entirely new synthetic
          compounds. For example, new anti-cancer drugs have been synthesised
          based on the human genetic sequence.
        </p>
        <h2>
          Benefits and challenges in filing chemical, biotech and pharmaceutical
          patents
        </h2>
        <p>
          Advances in the fields of chemistry, biotechnology and pharmaceuticals
          greatly affect the quality of life of humans, mostly for the better.
          However, inventors who bring about these innovations cannot benefit
          immediately after these technologies are revealed. Research and
          development place a large pressure for innovators to publish their
          work in journals to establish a pseudo &ldquo;prior claim&rdquo; over
          an invention of a chemical, biotech and pharmaceutical nature, but
          this practice results in the innovation being ineligible for patenting
          on the grounds of public disclosure before patent grant. Thus, a
          proper patent strategy should be in place, or else the inventors may
          end up forgoing the opportunity to maximise the commercial value of
          their innovations or even end up invalidating their patent
          applications altogether. A successful grant of a patent means
          exclusive rights of the patent owner over a certain innovation for 20
          years in most countries.
        </p>
        <p>
          The concept of patents in the chemical, biotech and pharmaceutical
          industries can be considered controversial because certain parties see
          patents as a way to stifle innovation and solely as a way to make a
          profit. However, patents are, to a certain extent, rewards to
          inventors for having contributed to science. How so? In return for
          having the patent in force, the patent owner makes the patent details
          public. Thus, the specifications in the patents provide background
          literature for future innovators to use in developing new or improved
          materials, processes and drugs.
        </p>
        <h3>
          Examples of granted chemical, biotech and pharmaceutical patent
          applications
        </h3>
        <table>
          <tbody>
            <tr>
              ...
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2018203740"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2018203740"
                      target="_blank"
                  ...
                  <dd>
                    Chemical inhibition of pitting corrosion in methanolic
                    solutions containing an organic halide
                  </dd>
                </dl>
                <p>
                  <small>Baker Hughes, a GE company, LLC</small>
                </p>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2019100244"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2019100244"
                      target="_blank"
                      rel="noopener noreferrer">
                  ...
                  <dd>
                    Textile and garment comprising a dual-weave of composite
                    materials
                  </dd>
                </dl>
                <p>
                  <small>Saint IP Pty Ltd</small>
                </p>
              </td>
            </tr>
            <tr>
              <th>Medical materials</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2014292503"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2014292503"
                      target="_blank"
                      rel="noopener noreferrer">
                      AU Patent # 2014292503
                    </Link>
                  </dt>
                  <dd>Biomimetic collagen–hydroxyapatite composite material</dd>
                </dl>
                <p>
                  <small>Geistlich Pharma AG</small>
                </p>
              </td>
            </tr>
            <tr>
              <th>Nano-materials</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2006225095"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2006225095"
                      target="_blank"
                      rel="noopener noreferrer">
                      AU Patent # 2006225095
                    </Link>
                  </dt>
                  <dd>Rare earth nanorods</dd>
                </dl>
                <p>
                  <small>Antaria Ltd</small>
                </p>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2018100854"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2018100854"
                      target="_blank"
                      rel="noopener noreferrer">
                ...
                <p>
                  <small>Guangzhou Bobei Info-tech Ltd</small>
                </p>
              </td>
            </tr>
            <tr>
              <th>Chemical and industrial processes</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2015299202"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2015299202"
                      target="_blank"
                      rel="noopener noreferrer">
                  ...
                  <dd>
                    Energy-efficient and environmentally friendly process for
                    the production of target chemical compounds from cellulosic
                    material
                  </dd>
                </dl>
                <p>
                  <small>Clariant International Ltd</small>
                </p>
              </td>
            </tr>
            <tr>
              <th>Hydrocarbon extraction and refining</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2014265950"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2014265950"
                      target="_blank"
                      rel="noopener noreferrer">
                      AU Patent # 2014265950
                    </Link>
                  </dt>
                  <dd>Methods for separating hydrocarbon gases</dd>
                </dl>
                <p>
                  <small>Linde Engineering North America, Inc</small>
                </p>
              </td>
            </tr>
            <tr>
              <th>Mining processes and mineral extraction</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2017203383"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2017203383"
                      target="_blank"
                      rel="noopener noreferrer">
                  ...
                  <dd>
                    Beneficiation process for enhancing uranium mineral
                    processing
                  </dd>
                </dl>
                <p>
                  <small>Uranium Beneficiation Pty Ltd</small>
                </p>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2014367284"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2014367284"
                      target="_blank"
                      rel="noopener noreferrer">
                      AU Patent # 2014367284
                    </Link>
                  </dt>
                  <dd>WNT pathway modulators</dd>
                </dl>
                <p>
                  <small>Agency for Science, Technology and Research</small>
                </p>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2018101116"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2018101116"
                      target="_blank"
                      rel="noopener noreferrer">
                  ...
                  <dd>
                    Vitamin drug intermediates diketone guluronic acid synthesis
                    method
                  </dd>
                </dl>
                <p>
                  <small>Chengdu Ka Di Fu Technology Co. Ltd</small>
                </p>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2013269536"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2013269536"
                      target="_blank"
                      rel="noopener noreferrer">
                      AU Patent # 2013269536
                    </Link>
                  </dt>
                  <dd>High-capacity storage of digital information in DNA</dd>
                </dl>
                <p>
                  <small>European Molecular Biology Laboratory</small>
                </p>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2017201900"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2017201900"
                      target="_blank"
                      rel="noopener noreferrer">
                  ...
                  <dd>
                    ...
                    attention-deficit, hyperactivity disorder (AFHD) and methods
                    of use thereof for the diagnosis and treatment of the same
                  </dd>
                </dl>
                <p>
                  <small>The Children’s Hospital of Philadelphia</small>
                </p>
              </td>
            </tr>
            <tr>
              <th>Antibody technology and characterisation</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2017203225"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2017203225"
                      target="_blank"
                      rel="noopener noreferrer">
                  ...
                  <dd>
                    A monoclonal antibody inhibiting immunosuppressive functions
                    of pathogens, antigen-binding fragment thereof, and
                    hybridomas producing such antibody
                  </dd>
                </dl>
                <p>
                  <small>Sagabio Co., Ltd</small>
                </p>
              </td>
            </tr>
            <tr>
              <th>Gene silencing and RNA interference</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2013257445"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2013257445"
                      target="_blank"
                      rel="noopener noreferrer">
                ...
                <p>
                  <small>Alnylam Pharmaceuticals, Inc</small>
                </p>
              </td>
            </tr>
            <tr>
              <th>
                Infectious diseases, particularly viral infectious diseases such
              ...
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2015371255"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2015371255"
                      target="_blank"
                      rel="noopener noreferrer">
                      AU Patent # 2015371255
                    </Link>
                  </dt>
                  <dd>Fused pyrimidine compounds for the treatment of HIV</dd>
                </dl>
                <p>
                  <small>
                    Gilead Sciences, Inc.; Institute of Organic Chemistry and
                    Biochemistry of the AS CR, v.v.i.
                  </small>
                </p>
              </td>
            </tr>
            <tr>
              <th>Stem cell isolation and culture</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2017239554"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2017239554"
                      target="_blank"
                      rel="noopener noreferrer">
                      AU Patent # 2017239554
                    </Link>
                  </dt>
                  <dd>Stem cell factor inhibitor</dd>
                </dl>
                <p>
                  <small>The Regents of the University of Michigan</small>
                </p>
              </td>
            </tr>
            <tr>
              <th>Protein structure and function</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2013220749"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2013220749"
                      target="_blank"
                      rel="noopener noreferrer">
                  ...
                  <dd>
                    Nucleic acid comprising or coding for a histone stem-loop
                    and a poly(A) sequence or a polyadenylation signal for
                    increasing the expression of an encoded therapeutic protein
                  </dd>
                </dl>
                <p>
                  <small>CureVac AG</small>
                </p>
              </td>
            </tr>
            <tr>
              <th>Cancer biology and genetics</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2017258877"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2017258877"
                      target="_blank"
                      rel="noopener noreferrer">
                      AU Patent # 2017258877
                    </Link>
                  </dt>
                  <dd>DNA vaccine for use in pancreatic cancer patients</dd>
                </dl>
                <p>
                  <small>Vaximm AG</small>
                </p>
              </td>
            </tr>
          </tbody>
        ...
        <h2>
          The Baxter IP approach to filing chemical, biotech and pharmaceutical
          patents
        </h2>
        <p>
          In order to maximise the value that the clients can obtain from their
          patent applications, a strategy suitable for many circumstances
        ...
        <ol>
          <li>
            ...
            &nbsp;in Australia with numerous claims including multiple claim
            types
          </li>
          <li>
            Request an&nbsp;
            <Link href="https://www.baxterip.com.au/international-type-search">
              International Type Search
            </Link>
            &nbsp;so as to gain an independent assessment of patentability
          </li>
          <li>
            If international protection is required, file a&nbsp;
            <Link href="https://www.baxterip.com.au/pct-patent">
              PCT (international) application
            </Link>
            , or if protection in only one or two countries is required, file
            complete national application(s). In either case, the application(s)
            claim priority from the original provisional application and the
            specification may be amended in light of the results of the Search.
          </li>
          <li>
            If infringement is suspected in Australia, a divisional innovation
            may be filed. This leads to rapid grant of a patent so as to allow
            for prompt legal action against the suspected infringer. Longer term
            protection is then afforded by the parent complete application. Note
            that it is possible that the innovation system in Australia will
            cease in the next few years, so this aspect of the strategy may be
            short-lived.
          </li>
          <li>
            File national phase applications from the PCT application in the
            countries of interest, amending the claims to conform with the
            requirements of each separate jurisdiction and taking into account
            any excess claims fees that may be payable.
          </li>
        </ol>
        <p>
        ...
        <h3>Claims Type</h3>
        <p>
          A range of different types of claims may be used in drafting chemical
          and pharmaceutical patent specifications. It is important to include
          as many of these as possible to allow for different patent conventions
          and rules in different jurisdictions. For example:
        </p>
        <h4>
          (i) Compound&nbsp;<em>per se</em>
        </h4>
        <p>
          It is important where possible to claim a compound or class of
          compounds per se. This will often be in the form of a Markush claim,
          which provides for various alternatives for various groups in a
          chemical structure. It is important that the claimed structure does
          not encompass known compounds and that all compounds within the scope
          can reasonably be expected to meet the aim of the invention. Thus, for
          example, if a claim is to a compound for treating liver cancer, it
          should be reasonably predictable that all compounds within the scope
          of the claim have some (not necessarily high) activity against liver
          cancer.
        </p>
        <h4>(ii) Process</h4>
        <p>
          Claims to a generic process for making the compounds can also be of
          value. This can enable action against a manufacturer, who is generally
          more able to pay large damages than an individual user.
        </p>
        <h4>(iii) First Medical Use</h4>
        <p>
          Occurs when a compound is known, and the invention resides in the use
          of it for treating a disease. Claim forms include:
        </p>
        <ol type="a">
          <li>
            <em>&ldquo;Compound A for use in therapy.&rdquo;</em>&nbsp;(this is
            a common claim form in Europe, where Swiss-style claims are not
            permitted),
          </li>
          <li>
            <em>&ldquo;Compound A when used in therapy.&rdquo;</em>
          </li>
        </ol>
        <h4>(iv) Second Medical Use</h4>
        <p>
          Occurs when compound A has been known for treating disease X, and the
          invention resides in the use of it for treating a different disease Y.
          Claim types include:
        </p>
        <ol type="a">
          <li>
            <em>&ldquo;Compound A when used in treating Y.&rdquo;</em>
            &nbsp;(this is commonly used in Australia, where the &ldquo;for
            use&rdquo; form is considered non-limiting),
          </li>
          <li>
            <em>&ldquo;Compound A for treatment of Y.&rdquo;</em>&nbsp;(more
            common in Europe)
          </li>
          <li>
            <em>&ldquo;Use of compound A for treatment of Y.&rdquo;</em>
          </li>
          <li>
            <em>
              &ldquo;Method of treating Y comprising administering a
              therapeutically effective quantity of compound A to a subject in
              need thereof.&rdquo;
            </em>
          </li>
        </ol>
        <h4>(v) Swiss-style Claims</h4>
        <p>
          These are a form of second medical use claim which was developed in
          jurisdictions (particularly Europe) to:
        </p>
        <ol type="a">
          <li>
            avoid patent subject matter exclusions to methods of treatment
            claims; and
          </li>
          <li>target manufacturers rather than users as infringers.</li>
        </ol>
        <p>
          Swiss-style claims are of the form &ldquo;Use of compound A for the
          manufacture of a medicament for the treatment of Y&rdquo;. Although
          Swiss-style claims originated in Europe, the European Patent Office no
          longer allows them, preferring the &ldquo;compound for use&rdquo;
          form.
        </p>
        <h3>
          Examples of chemical, biotech and pharmaceutical patent applications
          filed through Baxter IP
        </h3>
        <ol>
          <li>
            <Link
              title="AU Patent #2019100134"
              href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2019100134">
              <i>AU Patent #2019100134</i>
            </Link>
            &nbsp;–&nbsp;
            <strong>
              A plant-derived germicidal deodorant for environmental treatment
              and its preparation method.&nbsp;
            </strong>
            Beijing Hongna Luyuan Technology Development Co., Ltd
          </li>
          <li>
            <Link
              title="AU Patent #2018101677"
              href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2018101677">
              <i>AU Patent #2018101677</i>
            </Link>
            &nbsp;–&nbsp;
            <strong>
              Apparatus and method for preparing multi-component alloy
              film.&nbsp;
            </strong>
            The Academy of Opto-electronics, Chinese Academy of Sciences
          </li>
          <li>
            <Link
              title="AU Patent #2015201203"
              href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2015201203">
              <i>AU Patent #2015201203</i>
            </Link>
            &nbsp;–&nbsp;
            <strong>
              A dietary supplement composition as a prophylactic and treatment
              for skin diseases such as eczema and psoriasis and the like and
              method of treatment.&nbsp;
            </strong>
            Fischer, Karen
          </li>
          <li>
            <Link
              title="AU Patent #2012362360"
              href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2012362360">
              <i>AU Patent #2012362360</i>
            </Link>
            &nbsp;–&nbsp;
            <strong>
      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6 not-format">
        ...
        <p>
          <Link href="https://www.baxterip.com.au/melbourne/warren-chandler">
            Warren Chandler
          </Link>
          &nbsp;is a highly experienced patent attorney, an applied chemist and
          worked at CSIRO in field of pharmaceutical and drug delivery systems
          for treatment of diseased states. Warren has drafted and prosecuted
          numerous patent applications in the medical field including nasal
          dilation devices, mandibular advancement devices, devices for
        ...
        <p>
          <svg
            ...
            <text
              ...
              fill="#011d3b"
              font-size="19.31"
              transform="translate(291.77 424.71)">
              Brazil
            </text>
            <text
              font-weight="500"
