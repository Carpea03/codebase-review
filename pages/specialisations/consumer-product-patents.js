    ...
    <Layout>
      ...
      <div>
        ...
        <p>
          ...
          disregard the importance of filing patent applications for them.
          However, often the simplest innovations are the most profitable and
          carry the least commercialisation risk.
        </p>
        <p>
          Contrary to popular belief, simplicity is absolutely no bar to
          patentability – patents are granted and designs are registered on new
          consumer products every day and are enforced around the world. This
          allows companies and entrepreneurs to benefit financially from their
          bright ideas and investment in their own inventions.
        </p>
        <h2>What products are patentable?</h2>
        <p>
          So long as your consumer product is new, inventive and has functional
          utility, it should be patentable in any country around the world.
        </p>
        <h3>
          Benefits and challenges of filing consumer product patent applications
        </h3>
        <p>
          Consumer products have some of the lowest commercialisation risks
          among patent industries. However, inventors and innovators see little
          value in pursuing a patent strategy for consumer products, which
          usually are fast moving but of lower cost to develop compared with
          other technologies.
        </p>
        <p>
          One could consider the volume that can be acquired in the market for
          these consumer products: if successful in identifying the gap in the
          market and supplying the market with the goods, there is a huge
          potential to own that market share. Similarly large is the possibility
          that a competitor can eye and covet a chunk or all of that market
          share by positioning a similar product based on your product. In this
          case, a carefully designed patent portfolio can go a long way in
          protecting both the invented product and the possible tweaks to the
          product. How? By involving patent attorneys that understand both the
          technological and the business aspects of bringing a product into the
          market.
        </p>
        <p>
          Foresight is important: “How will my competitor tweak my product to
          make it their own without infringing on my existing patents?” and
          design a patent strategy to address the possible answers.
        </p>
        <h3>Examples of granted consumer product patent applications</h3>
        <table>
          <tbody>
            <tr>
              <th scope="row">Consumer electronics</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2004204969"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2004204969"
                      target="_blank"
                ...
                <p>
                  <small>Disney Enterprises, Inc</small>
                </p>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2016253711"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2016253711"
                      target="_blank"
                      rel="noopener noreferrer">
                      AU Patent # 2016253711
                    </Link>
                  </dt>
                  <dd>Electrically operated kitchen appliance</dd>
                </dl>
                <p>
                  <small>Vorwerk &amp; Co. Interholding GmbH</small>
                </p>
              </td>
            </tr>
            <tr>
              <th scope="row">
                Clothing, footwear &amp; fashion (patent applications &amp;
                registered designs)
              </th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2015367820"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2015367820"
                      target="_blank"
                      rel="noopener noreferrer">
                      AU Patent # 2015367820
                    </Link>
                  </dt>
                  <dd>Shoe having upper and sole</dd>
                </dl>
                <p>
                  <small>ASICS Corporation</small>
                </p>
              </td>
            </tr>
            <tr>
              <th scope="row">Sporting equipment</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2017202083"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2017202083"
                      target="_blank"
                      rel="noopener noreferrer">
                  ...
                  <dd>
                    Aquatic sport performance garment with restraints and method
                    of making same
                  </dd>
                </dl>
                <p>
                  <small>Roka Sports, Inc</small>
                </p>
              </td>
            </tr>
            <tr>
              <th scope="row">Toys &amp; novelty goods</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2017100043"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2017100043"
                      target="_blank"
                      rel="noopener noreferrer">
                  ...
                  <dd>
                    EDUCATIONAL TOY is an invention that can be useful as a toy
                    and as an educational device for children.The toy allows
                    children to construct various height stands and various
                    angles for rolling a variety of objects down channels. The
                    toy can be made in the form of various materials including
                    natural bamboo, timber or plastic or any other material. The
                    toy is intended to help children experiment and explore
                    different angles, weights of objects and build their
                    foundational mathematical/scientific understanding of force
                    and motion.
                  </dd>
                </dl>
                <p>
                  <small>Explore Nook Pty Ltd</small>
                </p>
              </td>
            </tr>
            <tr>
              <th scope="row">Architectural fittings</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2016210686"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2016210686"
                      target="_blank"
                      rel="noopener noreferrer">
                      AU Patent # 2016210686
                    </Link>
                  </dt>
                  <dd>A lock and latch assembly</dd>
                </dl>
                <p>
                  <small>Illinois Tool Works, Inc</small>
                </p>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2018101784"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2018101784"
                      target="_blank"
                      rel="noopener noreferrer">
                      AU Patent # 2018101784
                    </Link>
                  </dt>
                  <dd>Chair bracing apparatus</dd>
                </dl>
                <p>
                  <small>Van Tonder, Andries Johan</small>
                </p>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2015258251"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2015258251"
                      target="_blank"
                      rel="noopener noreferrer">
                  ...
                  <dd>
                    A cap and blister pack housing a substance and having an
                    integral piercing implement
                  </dd>
                </dl>
                <p>
                  <small>Kambouris Shares Pty Ltd</small>
                </p>
              </td>
            </tr>
            <tr>
              <th scope="row">Tapware</th>
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2017100689"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2017100689"
                      target="_blank"
                      rel="noopener noreferrer">
                      AU Patent # 2017100689
                    </Link>
                  </dt>
                  <dd>Ultra-thin double-sided shower head</dd>
                </dl>
                <p>
                  <small>Fujian Xihe Sanitary Ware Technology Co., Ltd</small>
                </p>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <dl>
                  <dt>
                    <Link
                      title="AU Patent # 2019100003"
                      href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2019100003"
                      target="_blank"
                      rel="noopener noreferrer">
                      AU Patent # 2019100003
                    </Link>
                  </dt>
                  <dd>Solar garden light</dd>
                </dl>
                <p>
                  <small>Hwang, Christina</small>
                </p>
              </td>
            </tr>
          </tbody>
        </table>
        <h2>The Baxter IP approach to filing consumer product patents</h2>
        <ol>
          <li>
            <b>Combination filing strategy</b>: Often consumer products that
            succeed in the market incorporate a certain amount of aggregation of
            incremental innovation. A combination of IP filing strategies
            including standard patents,{' '}
            <Link href="https://www.baxterip.com.au/innovation-patent-applications">
              innovation patents
            </Link>
            ,{' '}
            <Link href="https://www.baxterip.com.au/registered-designs">
              registered designs
            </Link>{' '}
            and{' '}
            <Link href="https://www.baxterip.com.au/how-to-trade-mark">
              trade marks
            </Link>{' '}
            works well to secure protection over as many of the new functional
            and aesthetic features as possible.
          </li>
          <li>
            <b>File early and file often</b>: Without an initial filing date,
            all it takes for a third party to make it impossible for you to gain
            patent protection is the disclosure of your product idea on the
            internet. Therefore, establishing an early patent filing date for
            your product by filing a{' '}
            <Link href="https://www.baxterip.com.au/provisional-patents">
              patent application
            </Link>{' '}
            is crucially important prior to any discussion with a third party.
            Some consumer products have a development lifecycle that extends
            over 6 months or more and clients often work with product
            development specialists, such as an industrial designer during this
            process.With each new step in the design or development of your
            product you or your industrial designer should consult with your
            patent attorney as to whether a further product patent application
            needs to be filed to cover new developments or whether the new
            developments were already anticipated in your original product{' '}
            <Link href="https://www.baxterip.com.au/provisional-patents">
              patent application
            </Link>
            .
        ...
        <h3>
          Examples of consumer product patent applications filed through Baxter
          IP
        </h3>
        <ol>
          <li>
            <Link
              title="AU Patent #2019901604"
              href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2019901604">
              <i>AU Patent #2019901604</i>
            </Link>{' '}
            – <strong>An improved tremolo device for electric guitars. </strong>
            Hildebrandt, James
          </li>
          <li>
            <Link
              title="AU Patent #2019900559"
              href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2019900559">
              <i>AU Patent #2019900559</i>
            </Link>{' '}
            – <strong>Safety wear. </strong>Location Aware Technologies
          </li>
          <li>
            <Link
              title="AU Patent #2019201085"
              href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2019201085">
              <i>AU Patent #2019201085</i>
            </Link>{' '}
            – <strong>Outdoor gas heater. </strong>Germania Home Appliance Co.,
            Ltd
          </li>
          <li>
            <Link
              title="AU Patent #2018903358"
              href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2018903358">
              <i>AU Patent #2018903358</i>
            </Link>{' '}
            – <strong>Clothes drying rack. </strong>Formica, Guy
          </li>
          <li>
            <Link
              title="AU Patent #2018902068"
              href="http://pericles.ipaustralia.gov.au/ols/auspat/applicationDetails.do?applicationNo=2018902068">
              <i>AU Patent #2018902068</i>
            </Link>{' '}
            – <strong>A cleaning pad. </strong>O&rsquo;Brien, Gary
          </li>
        </ol>
      </div>
      ...
      <div>
        ...
        <p>
          <svg
            ...
            <polygon
              fill="#d6d6d6"
              points="782.05 281.83 780.98 284.08 781.28 286.94 783.67 286.9 784.84 283.75 788.21 285.72 790.1 282.84 793.28 282.04 792.8 278.71 791.29 279.97 789.78 279.34 788.12 278.34 785.61 275.19 784.97 277.56 784.34 281.67 782.05 281.83"></polygon>
            <polygon
              fill="#d6d6d6"
              points="778.94 297.33 775.8 300.02 774.37 298.74 772.12 303.46 769.83 302.93 765.56 303.71 763.98 305.49 761.83 306.83 760.7 308.44 758.67 309.23 759.55 310.98 760.9 311.71 760.37 313.98 761.41 314.95 762.8 313.9 764.23 309.61 762.05 307.73 764.57 307.68 767.11 306.46 770.84 305.89 770.92 307.82 772.36 308.8 775.42 305.87 779.19 305.7 781.93 304.48 783.05 302.63 782.67 301.31 783.49 299.18 783.45 296.4 785.43 293.65 785.49 291.4 784.32 287.49 782.04 288.01 781.14 289.79 781.5 292.93 780.16 296.28 778.94 297.33"></polygon>
            <polygon
              fill="#d6d6d6"
            ...
            <polygon
              fill="#d6d6d6"
              points="836.7 430.59 836.01 429.95 835.07 429.18 833.86 428.4 832.94 428.37 833.24 429.14 834.66 430.75 836.04 431.96 837.57 433 838.76 433.62 839.57 433.06 838.46 432.01 836.7 430.59"></polygon>
            <polygon
              fill="#d6d6d6"
            ...
            <polygon
              fill="#d6d6d6"
              points="839.32 418.31 839.9 418.58 839.54 416.8 838.53 416.13 838.57 417.82 838.88 418.43 839.32 418.31"></polygon>
            <polygon
              fill="#d6d6d6"
            ...
            <text
              ...
              fill="#011d3b"
              font-size="19.31"
              transform="translate(639.26 440.94)">
              Australia
            </text>
            <text
              font-weight="500"
              ...
              fill="#011d3b"
              font-size="19.31"
              transform="translate(709.99 509.54)">
              New Zealand
            </text>
            <text
              font-weight="500"
        ...
        <ul>
          <li>
            <strong>USA</strong> – largest consumer product market in the world
          </li>
          <li>
            <strong>China</strong> – 90% of consumer products are manufactured
            in China and the 4th largest consumer market in the world
          </li>
          <li>
            <strong>Europe</strong> – many countries can be protected by a
            single product patent application and the 2nd largest consumer
            region in the world
          </li>
          <li>
            <strong>Australia</strong> – particularly if this is your pilot
            market and inexpensive
          </li>
          <li>
            <strong>New Zealand</strong> – inexpensive addition to an Australian
            application as our firm files directly in NZ too
          </li>
        </ul>
      </div>
      <div>
