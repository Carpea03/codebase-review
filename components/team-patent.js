...
const myLoader = ({ src, width, quality }) => {
  return `https://www.baxterip.com.au/wp-content/uploads/${src}?w=${width}&q=${
    quality || 75
  }`
}
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
          ...
          <div className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            <div className="text-center text-gray-500 dark:text-gray-400">
              <Image
                loader={myLoader}
                src="2021/01/square-chris-baxter-210x210.jpg"
                alt="Photo of Chris Baxter, Patent Attorney Sydney."
                width={210}
                height={210}
                className="mx-auto mb-4 w-36 h-36 rounded-full"
              />
              {/* <img className="mx-auto mb-4 w-36 h-36 rounded-full" src="bonnie-green.png" alt="Bonnie Avatar"> */}
              ...
              <ul className="flex justify-center mt-4 space-x-4">
                <li>
                  <Link href="/sydney/chris-baxter">
                    <a className="text-[#39569c] hover:text-gray-900 dark:hover:text-white">
                      <svg
                        className="w-6 h-6"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                ...
                <li>
                  <Link href="#">
                    <a className="text-[#00acee] hover:text-gray-900 dark:hover:text-white">
                      <svg
                        className="w-6 h-6"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                ...
                <li>
                  <Link href="#">
                    <a className="text-gray-900 hover:text-gray-900 dark:hover:text-white dark:text-gray-300">
                      <svg
                        className="w-6 h-6"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                ...
                <li>
                  <Link href="#">
                    <a className="text-[#ea4c89] hover:text-gray-900 dark:hover:text-white">
                      <svg
                        className="w-6 h-6"
                        fill="currentColor"
                        viewBox="0 0 24 24"
            ...
            <div className="text-center text-gray-500 dark:text-gray-400">
              <Image
                ...
                alt="Photo of Martin Earley, Patent Attorney Melbourne."
                width={210}
                height={210}
                className="mx-auto mb-4 w-36 h-36 rounded-full"
              />
