        ...
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl px-4 md:px-6 py-2.5">
          <Link href="/">
            <a className="flex items-center">
              ...
              />
              <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white pl-3">
                Flowbite
              </span>
            </a>
          </Link>
          <div className="flex items-center">
            ...
            <Link href="/">
              <a className="text-sm font-medium text-primary-600 dark:text-primary-500 hover:underline">
                Login
              </a>
            </Link>
            <span className="mr-0 ml-2 w-px h-5 bg-gray-200 dark:bg-gray-600 lg:inline lg:mr-3 lg:ml-5"></span>
            <Link href="/">
              <a className="inline-flex items-center p-2 text-sm font-medium text-gray-500 rounded-lg dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-600">
                <svg
                  className="w-4 h-4"
                  fill="currentColor"
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="grid py-4 px-4 mx-auto max-w-screen-xl lg:grid-cols-2 md:px-6">
          ...
          <div className="flex items-center lg:order-1">
            <ul className="flex flex-row mt-0 space-x-8 text-sm font-medium">
              ...
              <li>
                <Link href="/">
                  <a className="text-gray-900 dark:text-white hover:text-primary-600 dark:hover:text-primary-500">
                    Marketplace
                  </a>
                </Link>
              </li>
              <li>
                <Link href="/">
                  <a className="hidden text-gray-900 dark:text-white hover:text-primary-600 md:inline dark:hover:text-primary-500">
                    Resources
                  </a>
                </Link>
              </li>
      ...
      <nav
        ...
        <div className="grid py-4 px-4 mx-auto max-w-screen-xl text-gray-900 dark:text-white md:grid-cols-2 lg:grid-cols-4 md:px-6">
          <ul className="col-span-2 md:col-span-1">
            <li>
              <Link href="/">
                <a className="flex p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700">
                  <svg
          ...
          <div className="col-span-2 p-4 lg:col-span-1">
            ...
            <Link href="/">
              <a className="inline-flex items-center text-sm font-medium text-primary-600 hover:text-primary-600 dark:text-primary-500 dark:hover:text-primary-400">
                Explore our brands{' '}
                <svg
                  className="ml-1 w-4 h-4"
                  fill="currentColor"
